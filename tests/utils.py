...
def compare_mesh(mesh1, mesh2):
    ...
    if hasattr(mesh1, "edges"):
        comp.append(compare_container(mesh1.edges, mesh2.edges))
    if hasattr(mesh1, "faces"):
        comp.append(comp and compare_container(mesh1.faces, mesh2.faces))
    if hasattr(mesh1, "cells"):
        comp.append(compare_container(mesh1.cells, mesh2.cells))
    return comp
